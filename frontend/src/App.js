...
function App() {
  ...
  const getAllSaved = async () => {
    ...
    const response = await fetch("http://localhost:5003/cin", requestOptions);
    const data = await response.json();
  ...
  const addCompany = async (cin, name) => {
    ...
    const response = await fetch(
      "http://localhost:5003/check-duplicate",
      requestOptions
    );
    const data = await response.json();
    if (data.length) {
    ...
    await fetch("http://localhost:5003/cin", requestOptions);
    getAllSaved();
  };
  ...
  const deleteCompany = async (db_id) => {
    ...
    await fetch("http://localhost:5003/cin/" + db_id, requestOptions);
    getAllSaved();
  };
